...
#screen -dmS pcbpb 
nodeos --genesis-json ./genesis.json --blocks-dir ./blocks --config-dir ./pcbpb --data-dir ./pcbpb \
...
# screen -dmS pcbpl nodeos --genesis-json ./genesis.json --blocks-dir ./blocks --config-dir ./pcbpl --data-dir ./pcbpl \
...
# #screen -dmS pcbpv 
# nodeos --genesis-json ./genesis.json --blocks-dir ./blocks --config-dir ./pcbpv --data-dir ./pcbpv \
