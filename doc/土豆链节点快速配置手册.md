...
2. 创建矿工账号
    ...
    # 示例
    clpc system newaccount --stake-net "50.0000 POC" --stake-cpu "50.0000 POC" --buy-ram-kbytes 8888888 potato pcbpa \
...
3. 转账给矿工账号
    ...
    # 示例
    clpc transfer potato pcbpa "25000000.0000 POC" "trans to pcbpa"
    ```
4. 注册成矿工
    ...
    #示例
    clpc system regproducer pcbpa POC7n1U9Z2NQeVEvQZYjHCedNXRVWshmmuGH2j3r6bD4c8fH4U8QL https://192.168.0.57:8888
    ```
5. 抵押相应的资源
    ...
    # 示例
    clpc system delegatebw pcbpa pcbpa '12000000.0000 POC' '12000000.0000 POC'
    ```
6. 投票给自己
